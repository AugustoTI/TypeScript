...
/***/ "./src/020_exercicio/form-control.ts":
/*!*******************************************!*\
  !*** ./src/020_exercicio/form-control.ts ***!
  \*******************************************/
...
function checkForEmptyFields(...inputs) {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMessage(input, 'Esse campo não foi preenchido');
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/020_exercicio/form-control.ts");
